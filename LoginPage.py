...
class LoginPage(object):
    ...
    def __init__(self, window):
        ...
        # ============ Sign In label =============================================
        # ========================================================================
        self.sign_in_label = Label(self.lgn_frame, text="Login", bg="#15233c", fg="white",
        ...
        # ============================tài khoản====================================
        # ========================================================================
        self.username_label = Label(self.lgn_frame, text="Account", bg="#15233c", fg="white",
        ...
        self.login = Button(self.lgn_button_label, text='Log In',command=self.login,
        ...
        self.check_label = Label(self.lgn_frame, text=" Log in as Admin", bg="#15233c", fg="white",relief=FLAT,
        ...
        # ============================Mật khẩu====================================
        # ========================================================================
        self.password_label = Label(self.lgn_frame, text="Password", bg="#15233c", fg="white",
                                    font=("times new roman", 13, "bold"))
